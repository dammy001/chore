...
@section('content')
    <div class="movie-info border-b border-gray-500">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{$result['poster_path']}}" alt="movie" class="w-76 md:w-96 h-54">
            <div class="md:ml-24">
                <h2 class="text-4xl font-semibold">{{$result['title']}}</h2>
                <div class="flex items-center text-gray-400 flex-wrap text-sm md:flex-row">
                    <span>
                        <svg for="i in 10" :key="i" viewBox="0 0 24 24" :class="i <= {{ $result['vote_average'] }} ? 'text-teal-500' : 'text-gray-400'" class="h-4 w-12 fill-current">
