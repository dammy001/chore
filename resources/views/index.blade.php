            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    ...
                    <span class="mx-2">|</span>
                        ...
                        @auth
                        <div class="mt-3">
                            <a href="{{route('show', $result['id'])}}"class="bg-orange-600 block hover:bg-gray-700 items-center text-white font-bold w-full py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                View Details
                            </a>
                        </div>
                        @endauth
